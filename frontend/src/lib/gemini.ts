...
// "Nano Banana" image edit + gen model. Requires the API key's GCP project
// to have billing enabled (free tier is limit:0 on this model).
...
// ===== Image edit + generate (paid Gemini Image API) =====
